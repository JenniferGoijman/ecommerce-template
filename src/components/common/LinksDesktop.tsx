    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ref={ref}
          className={cn(
            "block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground hover:bg-dark-300",
            className
          )}
          {...props}
        >
          ...
          <p className="text-sm leading-snug line-clamp-2 text-muted-foreground text-gray-100">
            {children}
          </p>
        </a>
      </NavigationMenuLink>
